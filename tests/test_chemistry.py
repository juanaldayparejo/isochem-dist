...
def test_mass_reactions():
    ...
    #Calculating all available reactions with 15N chemistry
    rtype, ns, sf, sID, sISO, npr, pf, pID, pISO, rrates = isochem.chemistry.reaction_rate_coefficients(reaction_ids, gasID, isoID, h, p, t, n, include_15n=True)
    
    for ir in range(len(rtype)):
    ...
    #Calculating all available reactions with 13C chemistry 
    rtype, ns, sf, sID, sISO, npr, pf, pID, pISO, rrates = isochem.chemistry.reaction_rate_coefficients(reaction_ids, gasID, isoID, h, p, t, n, include_13c=True)
